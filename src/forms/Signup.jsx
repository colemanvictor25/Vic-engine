...
<form  className="max-w-sm mx-auto mt-12 rounded-lg shadow-md p-10" action="#" method="POST">
  <div className="mb-5">
    ...
    <input style={{background:"#343434",border:"none",outline:"#303030"}} type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="name@flowbite.com" required />
  </div>
  <div className="mb-5">
    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your password</label>
    <input style={{background:"#343434",border:"none",outline:"#303030"}} type="password" id="password" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
  </div>
  <div className="mb-5">
  ...
  <p className="text-white text-center bg-[#252525] p-3 ">
    <Link to="/signin">Enter the Engine  &nbsp; <FaPowerOff className="inline-block " style={{color:"yellowgreen"}} /></Link></p>
</form>
</>
